...
- Raw source metadata:
  - `raw/**/metadata.md`
  - Prioritize captures with `status: captured` or empty `processed_to`
  - Preserve source links in consolidated outputs through `raw_sources`
...
Durable knowledge should be classified into PARA inside `05-knowledge/`:
- `05-knowledge/projects/`
- `05-knowledge/areas/`
- `05-knowledge/resources/`
- `05-knowledge/archives/`

When a note introduces reusable concepts or relationships, add schema candidates for `/schema-compile`.
