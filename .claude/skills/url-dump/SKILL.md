...
### 2. Raw Capture First
- Before summarizing or categorizing, create `raw/articles/YYYY-MM-DD-[source-slug]/` or another appropriate `raw/<category>/` folder.
- Save the original URL and fetched source details in `metadata.md`.
- Link the final bookmark path back into `processed_to` after the processed note is written.

### 3. URL Validation & Fetch
- Validate URL format
...
raw_sources: ["raw/articles/YYYY-MM-DD-[source-slug]/metadata.md"]
---
...
### 7. Tool/Resource Special Handling
