...
If the PRD is based on external research, customer notes, screenshots, issue exports, docs, or pasted source material, capture those inputs under `raw/` before drafting. Add `raw_sources` frontmatter to the PRD and preserve source citations in requirement sections.
